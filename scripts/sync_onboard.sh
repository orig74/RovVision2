...
rsync -avzu --exclude=".git" --exclude="*.json" --include="*/" --include="*.c" --include="*.sh" --include="*.py" --include="*.ino" --exclude="*" $HOME/RovVision2/ stereo@stereo.local:/home/stereo/RovVision2/
sleep 2

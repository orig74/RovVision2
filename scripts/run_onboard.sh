...
tmux send-keys "gst-launch-1.0 v4l2src device=/dev/video4 ! video/x-raw,width=640 ! videoconvert ! videoflip method=vertical-flip ! x264enc tune=zerolatency bitrate=500 speed-preset=superfast ! rtph264pay ! udpsink host=169.254.0.2 port=17893" ENTER
